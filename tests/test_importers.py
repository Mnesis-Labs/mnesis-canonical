"""Tests for the XRoboToolkit pickle importer (D-19a, split 3/4).

Fixtures are synthetic, self-made data (see tests/fixtures/_generate.py) — no
third-party real data.
"""
